...
<div class="auth-wrapper">
	<div class="content text-center">
		<h4 class="text-white">Complaint management system <hr/><span style="color:#fff;"> User Password Recovery</span></h4>
		...
		<form method="post" name="passwordrecovery" onSubmit="return valid();">
			<div class="row align-items-center ">
				<div class="col-md-12">
					<form >
					<div class="card-body">
						<h4 class="mb-3 f-w-400 text-white">Reset Password</h4>
						<hr>
