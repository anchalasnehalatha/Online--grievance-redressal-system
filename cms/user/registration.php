				...
				<div class="col-md-12">
					...
					<div class="card-body">
						...
						<div class="form-group mb-3">
							...
							<!--<input type="text" id="mobile" class="contact form-control" maxlength="10" placeholder="enter your mobile number">
							<i class="fa-solid fa-badge-check"></i>
							<input type="button" value="Verify" onclick="val()">-->
...
<script>
        function validateForm() {
          ...
          if (!phonePattern.test(phone) && mobile.trim=="") {
