<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
				...
				<div class="m-header">
					...
					<a href="dashboard.php" class="b-brand">
						...
						<strong>Online Grievance</strong>
					</a>
...
?>
											<div class="media">
												...
												<div class="media-body">
													...
													<p>Complaint <a href="complaint-details.php?cid=<?php echo htmlentities($row['noc']);?>"><?php echo htmlentities($row['complaintNumber']);?> at <small><?php echo htmlentities($row['regDate']);?></small> </a></p>
												</div>
											</div>
											<br><?php $cnt=$cnt+1; } ?>
										</li>
