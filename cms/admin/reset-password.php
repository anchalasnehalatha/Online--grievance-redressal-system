...
<div class="auth-wrapper">
	<div class="content text-center">
			<h4 class="text-white">Online Grievance Redressal System <hr/><span style="color:#fff;"> Admin Password Recovery</span></h4>
			...
			<div class="row align-items-center ">
				<div class="col-md-12">
					...
					<div class="card-body">
						...
						<hr>
						<p class="mb-2 text-muted "><a href="index.php" class="f-w-400 text-white">Signin</a></p>
